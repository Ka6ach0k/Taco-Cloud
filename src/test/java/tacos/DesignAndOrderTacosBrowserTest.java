...
public class DesignAndOrderTacosBrowserTest {
    ...
    private void submitInvalidOrderForm() {
        Assertions.assertThat(
                browser.getCurrentUrl().startsWith(orderDetailsPageUrl())
        );
    ...
    private List<String> getValidationErrorsTexts() {
        List<WebElement> validationErrorsElement = browser.findElements(By.className("validationError"));
        List<String> validationErrors = validationErrorsElement.stream()
    ...
    void assertIngredient(WebElement ingredientGroup,
    ...
    public String designPageUrl() {
        return homePageUrl() + "design";
    }

    public String orderDetailsPageUrl() {
        return homePageUrl() + "orders";
    }

    public String currentOrderDetailsPageUrl() {
